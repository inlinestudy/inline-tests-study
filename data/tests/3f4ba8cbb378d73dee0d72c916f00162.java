src/main/java/net/greghaines/jesque/worker/DefaultPoolExceptionHandler.java;38;itest("", 38).given(exception, new JedisNoScriptException("fff")).checkFalse(isLoadingDataset);
